...
namespace FitStore.Domain.Concrete
{
    ...
    {
        public string MailToAddress = "zamówienia@przykład.pl";
        public string MailFromAddress = "sklepfit@przykład.pl";
        ...
        public string FileLocation = @"c:\fitstore_emails";
    }
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                foreach (var line in cart.Lines)
                {
                    ...
                    body.AppendFormat("{0} x {1} (watość: {2:c", line.Quantity, line.Product.Name, subtotal);
